...
var drawTriangle = function(t,data,extra,bgColor,id){
    ...
    */
    ...
    LINE(P1x,P1y,P2x,P2y,1,"#ff00ff",0.7,false,10,"#00ffff");
    ...
    */
    ...
    LINE(Pmediox,Pmedioy,P3x,P3y,1,"#ff00ff",0.7,false,10,"#00ffff");
    ...
    ANGLE("traslacionX", traslacionX, 0, 0, 0, 0);
    LINE(tOriginX,100,traslacionX,100,10,"#0000ff",0.5,false,0,"#0000ff");
